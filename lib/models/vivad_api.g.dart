...
part of 'vivad_api.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VivadApi _$VivadApiFromJson(Map<String, dynamic> json) {
  return VivadApi(
      vivad_uuid: json['vivad_uuid'] as String,
      register_no: json['register_no'] as String,
      register_date: json['register_date'] as String,
      circle: json['circle_id'] as String,
      panchayat: json['panchayat_id'] as int,
      ...
      vivad_type: json['vivad_type_id'] as int,
...
Map<String, dynamic> _$VivadApiToJson(VivadApi instance) => <String, dynamic>{
